...
"@
        ...
        $jsonLink = "[View the JSON file](https://github.com/ChrisTitusTech/ATATOOLS/tree/main/$jsonFilePath)"
...
function Add-LinkAttributeToJson {
    ...
    foreach ($item in $jsonData.PSObject.Properties) {
        ...
        $docLink = "https://christitustech.github.io/ATATOOLS/$relativePath"
