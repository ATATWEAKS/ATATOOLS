...
if ((Get-Item ".\ATATOOLS.ps1" -ErrorAction SilentlyContinue).IsReadOnly) {
    Remove-Item ".\ATATOOLS.ps1" -Force
}

$OFS = "`r`n"
$scriptname = "ATATOOLS.ps1"
...
Update-Progress -Activity "Validating" -StatusMessage "Checking ATATOOLS.ps1 Syntax" -Percent 0
try {
    $null = Get-Command -Syntax .\ATATOOLS.ps1
} catch {
    Write-Warning "Syntax Validation for 'ATATOOLS.ps1' has failed"
