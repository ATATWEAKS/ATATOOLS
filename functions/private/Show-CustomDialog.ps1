function Show-CustomDialog {
    ...
    # Add "Winutil" text
    $ATATOOLSTextBlock = New-Object Windows.Controls.TextBlock
    $ATATOOLSTextBlock.Text = "Winutil"
    $ATATOOLSTextBlock.FontSize = $HeaderFontSize
    $ATATOOLSTextBlock.Foreground = $logocolor
    $ATATOOLSTextBlock.Margin = New-Object Windows.Thickness(10, 10, 10, 5)  # Add margins around the text block
    $stackPanel.Children.Add($ATATOOLSTextBlock)
