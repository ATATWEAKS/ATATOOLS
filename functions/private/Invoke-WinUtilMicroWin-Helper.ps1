...
function New-CheckInstall {
    ...
    if exist "%HOMEDRIVE%\Windows\ATATOOLS.ps1" (
        echo %HOMEDRIVE%\Windows\ATATOOLS.ps1 exists
    ) else (
        echo %HOMEDRIVE%\Windows\ATATOOLS.ps1 does not exist
    )
...
function New-FirstRun {
    ...
    $shortcutPath = Join-Path $desktopPath 'ATATOOLS.lnk'
