...
```ps1
[Net.ServicePointManager]::SecurityProtocol=[Net.SecurityProtocolType]::Tls12;iex(New-Object Net.WebClient).DownloadString('https://github.com/ChrisTitusTech/ATATOOLS/releases/latest/download/ATATOOLS.ps1')
```
...
- Windows taking longer to shut down:
  - [#69](https://github.com/ChrisTitusTech/ATATOOLS/issues/69) Turn on fast startup: Press Windows key + R, then type:
  ```
  ...
  powercfg /H off
  ```
- [#69](https://github.com/ChrisTitusTech/ATATOOLS/issues/69) [95](https://github.com/ChrisTitusTech/ATATOOLS/issues/95) [#232](https://github.com/ChrisTitusTech/ATATOOLS/issues/232) Windows Search does not work: Enable Background Apps
- [#198](https://github.com/ChrisTitusTech/ATATOOLS/issues/198) Xbox Game Bar Activation Broken: Set the Xbox Accessory Management Service to Automatic
```ps1
