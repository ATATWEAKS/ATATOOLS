...
### Fork the Repo
* Fork the WinUtil Repository [here](https://github.com/ChrisTitusTech/ATATOOLS) to create a copy that will be available in your repository list.
...
* Before committing your changes, please discard changes made to the `ATATOOLS.ps1` file, like the following:
